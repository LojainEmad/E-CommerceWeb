    ...
    public class DbInitializer(StoreDBContext context , UserManager<ApplicationUser> userManager , RoleManager<IdentityRole> roleManager , StoreIdentityDbContext identityDbContext) : IDbInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
                ...
                {
                    var data = await File.ReadAllTextAsync(@"..\Infrustructure\Persistence\Data\Seeds\brands.json");
                ...
                {
                    var data = await File.ReadAllTextAsync(@"..\Infrustructure\Persistence\Data\Seeds\types.json");
                ...
                {
                    var data = await File.ReadAllTextAsync(@"..\Infrustructure\Persistence\Data\Seeds\products.json");
